module Datapath(clk, rst, instr, immSel, regRW, ALUsrc, status, ALUop, MRW, PCsrc, WB, readRS1, ALU1, ALUout, readRS2, dataOut, currentPC, nextPC, immOut, offsetPC, writeRD);
